    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/mouvements/**", "/facture/**").authenticated()
                ...
                .requestMatchers("/contrats/demande", "/contrats/renouvellement").hasAnyRole("ADMIN", "GESTIONNAIRE", "COMPTABLE", "CLIENT")
